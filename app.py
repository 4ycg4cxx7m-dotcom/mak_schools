...
@app.route('/')
def qwerd():
    return render_template('qwerd.html')  # ✅ ПРОСТОЕ ИНТРО - БЕЗ regions!
...
search_all_files = [
    ...
    'all_schools.html', 'Информация_о_сайте.html', 'support.html',     'Asch_nskob_nsk_cent.html', 
...
def get_search_result_info(filename):
    mapping = {
        # Общие страницы
        'home.html': ('Главная', url_for('domoi')),
